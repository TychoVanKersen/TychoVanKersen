...
<body>
    <style>
        body {
            ...
            background-image: url(/Foto_Website/Thijs\ Support.png);
    ...
    <div class="content-container">
        <!-- Left Button -->
        <a href="https://eduofficenl-my.sharepoint.com/:f:/g/personal/518026_vistacollege_nl/EthUv3Di_jhAhIvFLOGO9NABmGN2QR0z1lZkd12AiyNK2w?e=5Lzp8P
            class="button">Website</a>

        <div id="text-container">
            <div id="text1"> <b> Artifactum </b><br><br>
