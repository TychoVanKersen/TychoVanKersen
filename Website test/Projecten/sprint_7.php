...
<body>
    ...
    <div class="content-container">
        <!-- Left Button -->
        <a href="https://eduofficenl-my.sharepoint.com/my?id=%2Fpersonal%2F519559%5Fvistacollege%5Fnl%2FDocuments%2FSprint%20opdrachten%20jaar%201%2Fsprint%207"
            class="button">OneDrive</a>

        <div id="text-container">
            <div id="text1"> <b> Sprint 7: 24 Heures du Mans</b><br><br>
